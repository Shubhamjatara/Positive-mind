...
export default function WhyUs() {
  return (
    <>
      ...
      <div className="w-full flex justify-center items-center flex-wrap gap-3 p-5 transition-all duration-300">
...
function Card({
  ...
  return (
    <div
      className="w-full max-w-[439px] h-[601px] rounded-[41px] overflow-hidden"
      ...
      >
        <div className="w-full h-full flex flex-col gap-3">
          ...
          <div className="w-full">
            <p className="text-[4vw]  md:text-2xl xl:text-3xl text-center">
